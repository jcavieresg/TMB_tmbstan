...
#             SKEW NORMAL MODEL
#=====================================
obj <- MakeADFun(tmb_data, random = c("smoothCoefs"), tmb_par, DLL="sn_tps")
...
saveRDS(obj, file='TMB_tps_sn.RDS')
...
#======================================================
## Time difference of 2.221024 hours!!
#======================================================
...
posterior_tps_sn <- as.matrix(fit_tps)

saveRDS(posterior_tps_sn, file='posterior_tps_sn.RDS')
saveRDS(fit_tps, file='stan_tps_sn.RDS')
