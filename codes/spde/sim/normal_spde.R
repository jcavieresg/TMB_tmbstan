...
run_tmb <- function(nloc){
  ...
  #mesh <- inla.mesh.create(loc = coords, refine = T)
  mesh$n
  plot(mesh, main = "")
...
p2 <- ggplot(df2, aes(y_sim)) +
  ...
  # ggtitle("Grid 2") + 
  # theme(plot.title = element_text(size = 22, hjust = 0.5))
  annotate("text", x = -Inf, y = Inf, hjust = -0.1, vjust = 1.1, label = "Grid 2", colour = "blue", size = 10)
...
p3 <- ggplot(df3, aes(y_sim)) +
  ...
  # ggtitle("Grid 3") + 
  # theme(plot.title = element_text(size = 22, hjust = 0.5))
  annotate("text", x = -Inf, y = Inf, hjust = -0.1, vjust = 1.1, label = "Grid 3", colour = "blue", size = 10)
...
p4 <- ggplot(df4, aes(y_sim)) +
  ...
  # ggtitle("Grid 4") + 
  # theme(plot.title = element_text(size = 22, hjust = 0.5))
  annotate("text", x = -Inf, y = Inf, hjust = -0.1, vjust = 1.1, label = "Grid 4", colour = "blue", size = 10)
...
p5 <- ggplot(df5, aes(y_sim)) +
  ...
  # ggtitle("Grid 5") + 
  # theme(plot.title = element_text(size = 22, hjust = 0.5))
  annotate("text", x = -Inf, y = Inf, hjust = -0.1, vjust = 1.1, label = "Grid 5", colour = "blue", size = 10)
...
p6 <- ggplot(df6, aes(y_sim)) +
  ...
  # ggtitle("Grid 6") + 
  # theme(plot.title = element_text(size = 22, hjust = 0.5))
  annotate("text", x = -Inf, y = Inf, hjust = -0.1, vjust = 1.1, label = "Grid 6", colour = "blue", size = 10)
